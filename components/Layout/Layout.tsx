...
const Layout: FC<LayoutProps> = (props) => {
  ...
  return (
    <div className="md:p-5 lg:p-[50px] w-screen h-screen">
      <span className="absolute top-[15px] opacity-40 hidden md:block left-1/2 -translate-x-1/2 font-semibold lowercase">TALENT AFRICA TYPING CHALLENGE TECHNICAL TEST</span>
